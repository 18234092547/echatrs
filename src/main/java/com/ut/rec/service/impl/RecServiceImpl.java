...
public class RecServiceImpl implements RecService {
	...
	public List<BarModel> getEchartStatis(String date) {
		 ...
		 * 
		 * 
		 * //String retString = ""; String year = "2017"; stringList =
		 * recDao.getValidMonth("2017"); for(String t:stringList){ retString +=
		 * t + ","; } List<Integer> intList= recDao.getValidMonthStatis("2017");
		 * for(int i:intList) retString += String.valueOf(i) + ";";
		 * 
		 */
		// return retString;
		// return "123";
	...
	public String addEchartFromat(List<Integer> normaList, List<Integer> specList) {
		...
		String series = "";
		series = "series:[ { name:'normal', type:'bar'," + "data:[ ";
		...
		series = "series:[ { name:'normal', type:'bar'," + "data:[ " + date1;

		// series += date1;
		series += "],}, " + "{ name: 'spec', type: 'bar', " + "data:[ " + date2 + "]," + "} ]";
